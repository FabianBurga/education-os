...
from app.api.v1.m11_router import router as m11_router
from app.api.v1.m12_router import router as m12_router
from app.api.v1.m13_router import router as m13_router
from app.api.v1.m14_router import router as m14_router
from app.api.v1.m15_router import router as m15_router
...
from app.api.v1.m23_router import router as m23_router
from app.api.v1.m24_router import router as m24_router
from app.api.v1.m25_router import router as m25_router
from app.db.session import get_session

router = APIRouter()
router.include_router(m25_router)
router.include_router(m24_router)
router.include_router(m23_router)
...
router.include_router(m15_router)
router.include_router(m14_router)
router.include_router(m13_router)
router.include_router(m12_router)
router.include_router(m11_router)
